...
//Get main from the jungle_temple_dispenser loot table and store it for later use
val main = jungle_temple_dispenser.getPool("main");

//jungle_temple_dispenser main
...
main.addItemEntry(<lootbags:itemlootbag>, 5);
main.addItemEntry(<fakeblocks:fakeblock_item>, 5);
main.addItemEntry(<enderio:itemAlloy:4>, 1);
main.addItemEntry(<weaponcaseloot:weaponcase>, 1);
main.addItemEntry(<betterbuilderswands:wandStone>, 1);
main.addItemEntry(<blockarmor:sticky_piston_helmet>, 1);
main.addItemEntry(<blockarmor:sticky_piston_chestplate>, 1);
main.addItemEntry(<blockarmor:sticky_piston_leggings>, 1);
main.addItemEntry(<blockarmor:sticky_piston_boots>, 1);
